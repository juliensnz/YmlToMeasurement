...
class ImportCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $response = $apiClient->getMeasurementFamilyApi()->upsertList($measurementFamilies);
    ...
    private function convertMeasurementFamily($measurementFamily, $measurementFamilyCode)
    {
        ...
        return [
            ...
            'labels' => [
                'en_US' => $measurementFamilyCode
            ],
            'standard_unit_code' => $standardUnit,
            'units' => $units
        ];
    }
